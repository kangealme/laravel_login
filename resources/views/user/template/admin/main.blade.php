...
<head>
    ...
    <link href="{{url('/assets/sbAdmin2/css/sb-admin-2.min.css')}}" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        @include('user.template.admin.sidebar')
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Main Content -->
            <!-- Topbar -->
                @include('user.template.admin.topbar')
            <!-- End of Topbar -->
            ...
            <!-- Footer -->
            @include('user.template.admin.footer')
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Click Tombol Logout untuk mengakhiri sesi ? </div>
